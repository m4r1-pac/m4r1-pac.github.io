...
<h3>
  we'll start with linux basics then we will treat the OS of the major (OS) out there, then we will continue with the programming languages that you will need through this course like (python, Golang, C++, Java, Ruby and finally Docker) through this course. 
</h3>
<h4>
